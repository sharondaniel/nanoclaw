...
### How to delegate
Send the user's question directly to the right agent using `<message to="sdp">` or `<message to="devops">`. Do NOT send any acknowledgment message like "I've asked the agent" or "I'll update you" — just delegate silently and wait.
